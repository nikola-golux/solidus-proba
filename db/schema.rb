...
ActiveRecord::Schema.define(version: 20160809152656) do
  ...
  add_index "spree_countries", ["iso"], name: "index_spree_countries_on_iso"
  ...
  add_index "spree_prices", ["country_iso"], name: "index_spree_prices_on_country_iso"
  ...
  add_index "spree_shipping_rate_taxes", ["shipping_rate_id"], name: "index_spree_shipping_rate_taxes_on_shipping_rate_id"
  add_index "spree_shipping_rate_taxes", ["tax_rate_id"], name: "index_spree_shipping_rate_taxes_on_tax_rate_id"
